...
def build_optimizer(params, opt):
    if opt.optim == 'rmsprop':
        ...
        return optim.Adam(filter(lambda p: p.requires_grad, params), opt.learning_rate, (opt.optim_alpha, opt.optim_beta), opt.optim_epsilon, weight_decay=opt.weight_decay)
    else:
