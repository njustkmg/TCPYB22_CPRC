...
def parse_opt():
    ...
    parser.add_argument('--input_fc_dir', type=str, default='/home/whc/Desktop/Noisy/code/AoANet-master/data/cocobu_fc',
                    help='path to the directory containing the preprocessed fc feats')
    parser.add_argument('--input_att_dir', type=str, default='/home/whc/Desktop/Noisy/code/AoANet-master/data/cocobu_att',
                    help='path to the directory containing the preprocessed att feats')
    parser.add_argument('--input_box_dir', type=str, default='/home/whc/Desktop/Noisy/code/AoANet-master/data/cocobu_box',
    ...
    parser.add_argument('--checkpoint_path', type=str, default='log/log_aoanet',
